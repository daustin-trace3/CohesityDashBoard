// Hand-rolled request validation helpers used by router.js (dell/unifi/
// nutanix plugin-sdk pattern) — a bundled plugin cannot require the host's
// express-validator, so createRouter must return a BARE (req, res, next)
// function and validation is re-implemented here, preserving the same 400
// status code + `{ error, details }` shape.
...
module.exports = {
  badRequest, fail, parseIntStrict, isNonEmptyString, isBooleanish, parseQueryInt,
};
