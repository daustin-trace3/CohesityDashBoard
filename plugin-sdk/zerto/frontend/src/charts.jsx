// Zerto plugin chart kit — renders via the host's Chart.js instance
...
// build the same chart.js `data`/`options` shapes the built-in Zerto
// ZertoOverviewPage already builds for react-chartjs-2 (a single Line
// chart for the VPG/RPO/alert trend). Dark theme defaults are deep-merged
// underneath whatever options a page supplies.
