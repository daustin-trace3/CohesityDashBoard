...
// ---------------------------------------------------------------------
// v1.2.0 addition: Settings page — RSC / CDM connection registration.
// v1.2.1: restyled to match the host dashboard's standard platform Settings
// pages (centered column, icon+title header, segmented tabs, bordered
// panels with an accent top rule, uppercase field labels, solid CTA).
// ---------------------------------------------------------------------
