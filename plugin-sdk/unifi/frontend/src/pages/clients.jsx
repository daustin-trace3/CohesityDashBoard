// Port of frontend/src/pages/unifi/UnifiClientsPage.jsx onto the plugin ui kit.
import {
  PageHeader, Badge, LoadingPanel, RefreshButton, LastUpdated,
  useTableControls, SortTh, TableControls, TablePager,
  apiFetch, fmtNum, fmtBytes, secsToHuman, signalTone, BRAND,
} from '../ui.jsx';
...
export default function UnifiClientsPage() {
  ...
  const load = React.useCallback(() => apiFetch('/unifi/clients')
