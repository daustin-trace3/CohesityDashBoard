// vCenter plugin chart kit — renders via the host's Chart.js instance
...
// build the same chart.js `data`/`options` shapes the built-in vCenter pages
// already build for react-chartjs-2. Dark theme defaults are deep-merged
// underneath whatever options a page supplies. DoughnutChart is unused by
// vCenter's current pages (kept for parity with the golden template).
