// NetApp AI Advisor: capacity/replication-health/alert-triage reports. Ported
// from backend/services/advisors/netappAdvisor.js. The original module
...
// this exports a FACTORY — createNetappAdvisor(coreApi) — built lazily by
...
// directly.
function createNetappAdvisor(coreApi) {
  const db = coreApi.db;
...
module.exports = { createNetappAdvisor };
