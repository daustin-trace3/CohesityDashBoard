import { Router, X, Cable, ShieldCheck, Grid3x3 } from '../icons.jsx';
...
import {
  ...
  BRAND, fmtNum, fmtMs, statusTone, fmtStatus,
} from '../ui.jsx';
      ...
      <div className="relative panel w-full max-w-4xl max-h-[85vh] flex flex-col" style={{ borderTop: `3px solid ${BRAND}` }}>
        <div className="flex items-start justify-between p-4 pb-3 border-b border-cohesity-border">
          ...
          <div className="flex items-center gap-3 shrink-0">
            {switchId != null && (
              <ReactRouterDOM.Link to={`/brocade/portmap?switch=${switchId}`}
...
export default function BrocadeSwitchesPage() {
  ...
  const load = React.useCallback(() => client.get('/brocade/switches', { params: fabricParam ? { fabric: fabricParam } : {} })
