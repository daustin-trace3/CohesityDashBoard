...
// Fable-dev has no plugin registry — the platform list is static.
const STATIC_PLATFORMS = [
  { id: 'cohesity', label: 'Cohesity', color: '#6CB33F' },
  { id: 'pure', label: 'Pure', color: '#FE5000' },
  { id: 'netapp', label: 'NetApp', color: '#0067C5' },
  { id: 'zerto', label: 'Zerto', color: '#E4002B' },
  { id: 'vcenter', label: 'vCenter', color: '#78BE20' },
  { id: 'dell', label: 'Dell', color: '#007DB8' },
];
const usePlatforms = () => ({ platforms: STATIC_PLATFORMS });
