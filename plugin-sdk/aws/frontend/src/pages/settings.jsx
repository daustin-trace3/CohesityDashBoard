...
function PollNote({ text, tone }) {
  ...
  return (
    <p
      className={`text-[10px] mt-0.5 ${tone}`}
      style={open ? { maxWidth: 560, whiteSpace: 'pre-wrap', wordBreak: 'break-word', cursor: 'pointer' } : { maxWidth: 260, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', cursor: 'pointer' }}
