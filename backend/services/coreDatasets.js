...
const COHESITY_DATASETS = [
  {
    ...
    columns: [
      ...
      { key: 'total_capacity_bytes', label: 'Total Capacity (bytes)', type: 'number', aggregatable: true },
      { key: 'used_bytes', label: 'Used (bytes)', type: 'number', aggregatable: true },
      { key: 'logical_bytes', label: 'Logical (bytes)', type: 'number', aggregatable: true },
