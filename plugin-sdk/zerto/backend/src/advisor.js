// Zerto AI Advisor: DR-readiness/capacity-licensing/alert-triage reports.
// Ported from backend/services/advisors/zertoAdvisor.js. The original module
...
// this exports a FACTORY — createZertoAdvisor(coreApi) — built lazily by
...
// directly.
function createZertoAdvisor(coreApi) {
  const db = coreApi.db;
...
module.exports = { createZertoAdvisor };
