import { X, GitCompare, AlertTriangle, CheckCircle2 } from '../icons.jsx';
import { LineChart } from '../charts.jsx';
import client from '../api.js';
import { LoadingPanel, Badge, portalOrInline, BRAND, fmtWhen } from '../ui.jsx';
...
export default function BrocadePortCompareModal({ wwns, onClose }) {
  ...
  const hasData = React.useMemo(() => wwns.some((w) => (series[w] || []).some((pt) =>
              ...
              {!hasData ? (
                ...
                <>
                  <div>
                    ...
                    <LineChart data={framesChart} height={224} />
                  </div>
                  <div>
                    <p className="text-xs font-semibold text-ink mb-2">MB/s</p>
                    <LineChart data={mbChart} height={224} />
                  </div>
                </>
              )}
            </div>
