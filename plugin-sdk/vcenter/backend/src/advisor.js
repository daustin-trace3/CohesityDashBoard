// vCenter AI Advisor: capacity/operations/efficiency reports. Ported from
// backend/services/advisors/vcenterAdvisor.js. The original module eagerly
...
// this exports a FACTORY — createVcenterAdvisor(coreApi) — built lazily by
// router.js once coreApi is known (dell advisor.js pattern). Per the plugin
// contract, coreApi.advisor is the host's services/platformAdvisor module
// (createPlatformAdvisor/linReg/parseUtcMs/fmtBytes), never required directly.
function createVcenterAdvisor(coreApi) {
  const db = coreApi.db;
...
module.exports = { createVcenterAdvisor };
