...
export default function DellSettingsPage() {
  ...
  const add = async () => {
    setSaving(true);
    try {
      await client.post('/dell/instances', {
  ...
  return (
    <div className="animate-fade-in max-w-3xl">
      ...
      <div className="panel p-4 mb-4" style={{ borderTop: `3px solid ${BRAND}` }}>
        <p className="text-sm font-semibold text-ink mb-1 flex items-center gap-2"><Server size={15} className="text-brand" /> Add an OME instance</p>
        ...
        <div className="flex items-center gap-2">
          <button onClick={add} disabled={saving || !canSubmit}
            ...
            {saving ? 'Adding…' : 'Add OME instance'}
          </button>
