// Cohesity plugin chart kit — renders via the host's Chart.js instance
// (window.Chart, injected by esbuild define; see plugin-sdk/build.mjs).
// Ported from plugin-sdk/dell/frontend/src/charts.jsx. Pages build the same
// chart.js `data`/`options` shapes the built-in pages already built for
// react-chartjs-2. Dark theme defaults are deep-merged underneath whatever
// options a page supplies. Note: chartjs-plugin-zoom (pan/zoom on the
// Dashboard trend chart) is NOT among the sandbox's window globals — the
// zoom/pan/reset-zoom affordances from the built-in Dashboard are dropped.
