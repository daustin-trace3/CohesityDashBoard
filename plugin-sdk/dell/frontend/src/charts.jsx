// Dell plugin chart kit — renders via the host's Chart.js instance
...
// build the same chart.js `data`/`options` shapes the built-in Dell pages
...
// DellOverviewPage's device-health donut.
