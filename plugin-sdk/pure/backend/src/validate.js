// Hand-rolled request validation helpers shared across router.js (dell/zerto
// plugin-sdk pattern) — a bundled plugin cannot require the host's
...
// status code + `{ error, details }` shape as express-validator's
// validationResult(req).array() would have produced.
