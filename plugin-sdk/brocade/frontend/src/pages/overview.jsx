import { Gauge, Waypoints, Router, Cable, HardDrive, ShieldAlert, Server, Network, AlertTriangle } from '../icons.jsx';
...
export default function BrocadeOverviewPage() {
  ...
  const portsOnlineTrend = React.useMemo(() => ({
    ...
    <div className="animate-fade-in">
      ...
      <div className="grid lg:grid-cols-2 gap-4 mb-4">
        ...
        <div className="panel p-4" style={{ borderTop: `3px solid ${BRAND}` }}>
          ...
          {trends.length > 1 ? (
            <LineChart data={portsOnlineTrend} height={192} />
          ) : (
