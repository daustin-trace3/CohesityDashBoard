// BlueCat plugin chart kit - renders via the host's Chart.js instance
// (window.Chart, injected by esbuild define; see plugin-sdk/build.mjs).
// Ported from plugin-sdk/brocade/frontend/src/charts.jsx (itself ported from
// dell) - pages build the same chart.js data/options shapes the built-in
// BlueCat overview page already builds for react-chartjs-2. Dark theme
// defaults are deep-merged underneath whatever options a page supplies.
