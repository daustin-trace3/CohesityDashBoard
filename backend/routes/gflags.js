...
/** GET /api/gflags/changes?clusterId=&flag=&days= — audit history. */
router.get('/changes', [
...
/** POST /api/gflags/refresh?clusterId= — on-demand pull (all direct
...
/** GET /api/gflags/export?clusterId=&format=csv|json — support-case
