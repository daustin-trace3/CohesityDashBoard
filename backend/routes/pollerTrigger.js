// WP0: cohesity-owned half of the former routes/poller.js (pure file
// reorganization — same mounted path /api/poller, same response shape). The
// core status endpoint lives in routes/pollerStatus.js. Kept as a separate
// router so a future 'cohesity' pack conversion can own this file without
// touching the core status route.
