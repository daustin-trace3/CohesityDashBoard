// Aria plugin chart kit — renders via the host's Chart.js instance
...
// build the same chart.js `data`/`options` shapes the built-in Aria
// Overview page already builds for react-chartjs-2.
