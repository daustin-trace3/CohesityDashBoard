// Brocade plugin chart kit — renders via the host's Chart.js instance
// (window.Chart, injected by esbuild define; see plugin-sdk/build.mjs).
// Ported verbatim from plugin-sdk/dell/frontend/src/charts.jsx — pages build
// the same chart.js `data`/`options` shapes the built-in Brocade pages
