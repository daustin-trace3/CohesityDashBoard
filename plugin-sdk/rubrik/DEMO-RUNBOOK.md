...
## Files
- `rubrik-2.1.5.iccplugin` — the signed installable (also staged at `%USERPROFILE%\Desktop\`).
...
2. **Install**: drag `rubrik-2.1.5.iccplugin` onto the Plugins page upload target.
