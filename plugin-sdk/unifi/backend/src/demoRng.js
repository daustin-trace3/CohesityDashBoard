...
// backend/demo/generators/core.js (nutanix plugin-conversion precedent).
// Only the seeded-random utilities are ported — host core seeding (users,
// licence settings) stays in the host and is not a plugin concern.
