// Inline-SVG icon set for the NetApp plugin — no lucide-react import (plugin
// sandbox forbids host package imports). 24x24 viewBox, stroke-based,
// lucide-look; close-enough per the conversion contract. Base set cloned
// verbatim from plugin-sdk/dell/frontend/src/icons.jsx; NetApp-only
// additions appended at the bottom.
...
/* ── carried over from the Dell icon set (unused by some pages, kept for parity) ── */
...
/* ── NetApp-only additions ─────────────────────────────────────────────── */
export const FolderTree = (p) => <Icon {...p}><path d="M3 3v4a2 2 0 0 0 2 2h3" /><path d="M3 3h4l2 2h5a2 2 0 0 1 2 2v1" /><rect x="10" y="12" width="11" height="7" rx="1.5" /><path d="M3 7v11a2 2 0 0 0 2 2h4" /></Icon>;
export const Share2 = (p) => <Icon {...p}><circle cx="18" cy="5" r="3" /><circle cx="6" cy="12" r="3" /><circle cx="18" cy="19" r="3" /><path d="M8.6 10.5 15.4 6.5M8.6 13.5l6.8 4" /></Icon>;
...
export const CircuitBoard = (p) => <Icon {...p}><rect x="4" y="4" width="16" height="16" rx="2" /><circle cx="9" cy="9" r="1.5" /><path d="M14 7h3M14 12h3M7 14v3M12 14v3" /></Icon>;
export const Cloud = (p) => <Icon {...p}><path d="M17.5 19a4.5 4.5 0 0 0 0-9 6 6 0 0 0-11.4 1.8A4 4 0 0 0 6.5 19h11Z" /></Icon>;
export const Play = (p) => <Icon {...p}><path d="M6 4l14 8-14 8V4Z" /></Icon>;
export const PlugZap = (p) => <Icon {...p}><path d="M9 2v4M15 2v4" /><path d="M6 8h12v3a6 6 0 0 1-4 5.7V19h-4v-2.3A6 6 0 0 1 6 11V8Z" /><path d="M13 12l-2 3h3l-2 3" /></Icon>;
...
export const Users = (p) => <Icon {...p}><circle cx="9" cy="8" r="3.5" /><path d="M2.5 20a6.5 6.5 0 0 1 13 0" /><path d="M16.5 5.2a3.5 3.5 0 0 1 0 6.6" /><path d="M21.5 20a6 6 0 0 0-4.7-8" /></Icon>;
export const ArrowLeftRight = (p) => <Icon {...p}><path d="M8 3 4 7l4 4" /><path d="M4 7h16" /><path d="M16 21l4-4-4-4" /><path d="M20 17H4" /></Icon>;
export const ChevronUp = (p) => <Icon {...p}><path d="M18 15l-6-6-6 6" /></Icon>;
