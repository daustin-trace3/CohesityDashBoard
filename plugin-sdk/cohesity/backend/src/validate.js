// Hand-rolled request validation helpers shared by router.js and reports.js
// (unifi/nutanix router.js pattern) — a bundled plugin cannot require the
// host's express-validator, so createRouter must return a BARE
// (req, res, next) function and validation is re-implemented here,
// preserving the same 400 status code + `{ error, details }` shape.
