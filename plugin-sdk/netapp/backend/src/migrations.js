...
// Copied VERBATIM from backend/db/migrations/netapp.js (same scope id
// 'netapp') so an existing local DB's netapp_* data (and its
// schema_migrations row) is adopted intact on install.
module.exports = [
  {
    version: 1,
    up(db) {
