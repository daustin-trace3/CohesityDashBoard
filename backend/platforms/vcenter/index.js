  ...
  datasets: [
    {
      ...
      columns: [
        ...
        { key: 'cpu_mhz_capacity', label: 'CPU Capacity', type: 'number', unit: 'mhz', aggregatable: true },
        { key: 'cpu_mhz_used', label: 'CPU Used', type: 'number', unit: 'mhz', aggregatable: true },
        { key: 'mem_bytes_capacity', label: 'Memory Capacity', type: 'number', unit: 'bytes', aggregatable: true },
        { key: 'mem_bytes_used', label: 'Memory Used', type: 'number', unit: 'bytes', aggregatable: true },
      ],
    },
    {
