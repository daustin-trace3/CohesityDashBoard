...
//
// Copied VERBATIM from backend/db/migrations/netbackup.js — the host runs
// plugin migrations under the same plugin id 'netbackup', and an existing
// local DB already has schema_migrations rows for netbackup v1-v5, so on
