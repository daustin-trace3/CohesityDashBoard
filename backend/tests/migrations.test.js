...
const NEW_TABLES = [
  ...
  'vcenter_sites', 'vcenter_site_members', 'vcenter_site_pairs', 'vcenter_capacity_history', 'vcenter_datastore_history', 'vcenter_vm_capacity_history',
  ...
  'netbackup_appliance_conns', 'netbackup_appliance_hw',
  'pure_ai_reports', 'netapp_ai_reports', 'zerto_ai_reports',
  'vcenter_ai_reports', 'dell_ai_reports', 'aria_ai_reports',
  'bluecat_ai_reports', 'ariaops_ai_reports', 'brocade_ai_reports',
  'ai_audit_exchanges',
  'directory_sync_log',
